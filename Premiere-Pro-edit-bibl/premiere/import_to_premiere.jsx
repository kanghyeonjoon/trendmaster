...
//
// ⚠ 주의: 이 파일은 프리미어에서 '단독 실행'할 수 없습니다.
//   프리미어 프로에는 애프터이펙트 같은 File > Scripts > Run Script File 메뉴가 없어서,
//   .jsx를 돌리려면 CEP/UXP 패널(호스트)이 있어야 합니다.
//   → 지금은 수동 가져오기(파일 > 가져오기로 _cut.xml + _cut.srt)를 사용하세요.
//   → 이 파일은 '향후 CEP/UXP 패널을 붙일 때' 그 패널의 host 로직으로 재사용하려고 보관합니다.
//
